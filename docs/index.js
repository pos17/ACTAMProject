...
tour.addStep({
    id: 'melodytypeChoice',
    text: 'The different landscapes represents the different music styles generated by the system. Choose one of them!!',
    attachTo: {
        element: '.landscape',
        on: 'left'
    },
...
tour.addStep({
    id: 'environment',
    text: 'The main canvas visualizes the elements picked in the main while the generated music parts play',
    attachTo: {
        element: '.canvasTour',
        on: 'bottom'
    },
